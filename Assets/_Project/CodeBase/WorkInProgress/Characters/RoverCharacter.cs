...
public class RoverCharacter : CharacterBase
{
    ...
    public override void Move(Vector2 inputAxis)
    {
        ...
        {
            direction = CalculateDirectionVector(targetRotation, currentRotation, direction);
        }
    ...
    private Vector3 CalculateDirectionVector(Vector3 targetRotation, Vector3 currentRotation, Vector3 direction)
    {
